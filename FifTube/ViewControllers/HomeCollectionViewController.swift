...
class HomeCollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout, TopBarParent, VideoCategoryDelegate{
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        // Configure the cell
        cell.setup(videoListType: VideoListType(rawValue: indexPath.item) ?? .AllVideo, isUseMock: false )
        cell.delegate = self
        return cell
    }
